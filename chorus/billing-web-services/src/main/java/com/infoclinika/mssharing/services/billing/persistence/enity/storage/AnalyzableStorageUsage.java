...
public class AnalyzableStorageUsage extends ChargeableItemUsage {
    ...
    public AnalyzableStorageUsage(long lab, long user, long file1, long bytes, Date timestamp, String ownerName,
                                  String instrument, long price, String file) {
        super(lab, user, file1, bytes, timestamp, ownerName, instrument, price, file);
    }

    public AnalyzableStorageUsage(long lab, long user, Long file, long bytes, long timestamp, String ownerName,
