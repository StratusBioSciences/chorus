...
public class DailyAnalyzableStorageUsage extends AnalyzableStorageUsage {
    ...
    public DailyAnalyzableStorageUsage(long lab, long user, long file1, long bytes, Date timestamp, String ownerName,
                                       String instrument, long price, String file) {
        super(lab, user, file1, bytes, timestamp, ownerName, instrument, price, file);
    }

    public DailyAnalyzableStorageUsage(long lab, long user, Long file, long bytes, long timestamp, String ownerName,
