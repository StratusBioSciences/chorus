 ...
 */
@Component
public class HourlyAnalyzeDataLogUsageStrategy extends AbstractFeatureLogStrategy {

    @Inject
    public HourlyAnalyzeDataLogUsageStrategy(HourlyAnalyseStorageUsageRepository usageRepository) {
