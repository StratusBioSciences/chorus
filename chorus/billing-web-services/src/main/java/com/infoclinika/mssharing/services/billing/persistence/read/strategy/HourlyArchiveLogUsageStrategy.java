 ...
 */
@Component
public class HourlyArchiveLogUsageStrategy extends AbstractFeatureLogStrategy {

    @Inject
    protected HourlyArchiveLogUsageStrategy(HourlyArchiveStorageUsageRepository usageRepository) {
