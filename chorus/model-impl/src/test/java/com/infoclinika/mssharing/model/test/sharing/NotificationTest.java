...
public class NotificationTest extends AbstractSharingTest {
    ...
    public void testUserReceivesEmailOnProjectSharingDirectly() {
        ...
        final long proj = studyManagement.createProject(
            bob,
            new ProjectInfo(projName, generateString(), generateString(), uc.getLab3())
        );
        ...
        sharingManagement.updateSharingPolicy(
            bob,
            proj,
            ImmutableMap.of(poll, SharingManagementTemplate.Access.WRITE),
            emptySharing,
            true
        );
    ...
    public void testOldUsersDontReceivesEmailOnProjectSharing() {
        ...
        sharingManagement.updateSharingPolicy(
            bob,
            proj,
            ImmutableMap.of(kate, SharingManagementTemplate.Access.WRITE),
            emptySharing,
            true
        );
