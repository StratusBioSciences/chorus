...
import com.infoclinika.mssharing.web.controller.request.CompleteProjectAttachmentRequest;
...
public class ProjectAttachmentsController extends AbstractAttachmentsController {
    ...
    /**
     * Complete the attachment of the binary file to the appropriate project.
     * Should be called once the project creation or editing is confirmed by the client.
     *
     * @param request   the request containing the project and attachment IDs to wire up.
