...
(function () {
    ...
    angular
        .module("trash-front", ["trash-back", "formatters", "error-catcher"])
        ...
        .factory(
            "TrashControllerCommon",
            ["$route", "Trash", "DashboardButtonFactory", "DashboardButton",
                            ...
                            setup: function (selectedFiles, callback) {
                                $scope.$watch(function ($scope) {
                                    ...
                                    $scope.allItemsSelected =
                                        $scope.trash.length > 0 && selectedItems.length == $scope.trash.length;
                                });
                                ...
                                var switchRestoreButton = function (selectedItems) {
                                    ...
                                    button.onClickHandler = function () {
                                        ...
                                        $scope.notRestorableItems =
                                            Trash.readNotRestorableItems({
                                        ...
                                        $scope.restoreSelectedPopup =
                                            new FilesSelectedPopup("#restore-selected-confirmation", function () {
