...
public abstract class DefaultFileReader<FILE extends FileMetaDataTemplate,
    LINE extends FileReaderTemplate.FileLineTemplate>
    ...
    @PostConstruct
    private void init() {
        fileReaderHelper.setTransformer(this::transform);
    }
    ...
    public PagedItem<LINE> readFiles(long actor, Filter filter, PagedItemInfo pagedItemInfo) {
        ...
        PageRequest pageRequest = toPageRequest(FileMetaDataTemplate.class, pagedItemInfo);
    ...
    public PagedItem<LINE> readFilesByExperiment(long actor, long experiment, PagedItemInfo pagedInfo) {
        ...
        Pageable request = toPageRequest(ExperimentFileTemplate.class, pagedInfo);
