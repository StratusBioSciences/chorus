...
public class NotificationTest extends AbstractSharingTest {
    ...
    public void testUserReceivesEmailOnProjectSharingDirectly() {
        ...
        final long proj = projectManagement
            .createProject(bob, new ProjectInfoTemplate(uc.getLab3(), projName, generateString(), generateString()));
        final NotifierTemplate notifier = notificator();

        sharingManagement.updateSharingPolicy(bob, proj, ImmutableMap.of(poll, WRITE), emptySharing, true);
    ...
    public void testUserReceivesEmailOnProjectSharingThrowGroup() {
        ...
        sharingManagement.updateSharingPolicy(bob, proj, emptySharing, ImmutableMap.of(group, WRITE), true);
    ...
    public void testUserDontReceiveEmailOnProjectSharingThroughGroupEditingIfItWasMarked() {
        ...
        final NotifierTemplate notifier = notificator();
        final long group = sharingManagement.createGroup(bob, generateString(), ImmutableSet.of(paul));
        sharingManagement.updateSharingPolicy(bob, proj, emptySharing, ImmutableMap.of(group, WRITE), false);
    ...
    public void testUserDontReceivesEmailOnProjectSharingIfItsWasNotSpecified() {
        ...
        sharingManagement.updateSharingPolicy(bob, proj, ImmutableMap.of(poll, WRITE), emptySharing, false);
    ...
    public void testOldUsersDontReceivesEmailOnProjectSharing() {
        ...
        sharingManagement.updateSharingPolicy(bob, proj, ImmutableMap.of(poll, WRITE), emptySharing, false);
        sharingManagement.updateSharingPolicy(bob, proj, ImmutableMap.of(kate, WRITE), emptySharing, true);
    ...
    public void testUserDontGetNotificationWhenProjectSharedWithHimBecomePublic() {
        ...
        sharingManagement.updateSharingPolicy(bob, project, ImmutableMap.of(poll, WRITE), emptySharing, false);
